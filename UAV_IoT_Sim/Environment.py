...
# Custom Packages
from UAV_IoT_Sim import IoT_Device
...
class sim_env:
    def __init__(self, scene, num_sensors, num_clusterheads, max_num_steps):
        ...
        if(scene == "test"):
            ...
            self.times = pd.date_range('2021-01-01 9:00', freq=self.stepSize, periods=max_num_steps, tz="MST")
